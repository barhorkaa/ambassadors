...
export default function DeleteMaterialModal({ materialId }: { materialId: string }) {
  return (
    <ModalLayout id={materialId} title={'Opravdu chcete smazat tento materiál?'} modalType={'delete'}>
      <div className="pt-4 flex flex-col gap-4">
        ...
        <div className="flex justify-end">
          <DeleteButton fun={deleteMaterialAction} id={materialId} modalId={materialId} />
        </div>
      </div>
    </ModalLayout>
  );

import { creatEventAction, updateEventAction } from '@/app/lib/actions/events';
...
export default async function EventForm(data: { eventTypes: EventTypeBasicModel[]; event: EventDetailModel | null }) {
  return (
    <form action={data.event === null ? creatEventAction : updateEventAction} className="card-body">

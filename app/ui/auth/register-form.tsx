  ...
  return (
    <form action={dispatch} className="card-body">
      <div className="form-control">
        ...
        <input id="name" type="text" name="name" placeholder="Jméno" required />
      </div>
      <div className="form-control">
      ...
      <div className="form-control">
        ...
        <input id="uco" type="number" name="uco" placeholder="UČO" required />
      </div>
      <div className="form-control">
        <label className="label" htmlFor="phoneNumber">
          <span className="label-text">Telefonní číslo</span>
        </label>
        <input id="phoneNumber" type="number" name="phoneNumber" placeholder="Telefónní číslo" required />
      </div>

...
export default async function unapprovedEvents() {
  console.log('calling get all unapproved events at: ', new Date().toLocaleString());
  const allUnapprovedEvents: EventModel[] = await getAllActiveEvents(false);
  console.log('got result in component from get all unapproved events at: ', new Date().toLocaleString());
